...
htmlhelp_basename = '{}doc'.format(metadata["name"])
...
latex_documents = [
    (master_doc, "{}.tex".format(metadata['name']) , "{} Documentation".format(metadata['name']),
     [author], 1)
]
...
man_pages = [
    (master_doc, metadata['name'], metadata['name'],
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, metadata['name'], metadata['description'],
     author, metadata['name'], 'One line description of project.',
     'Miscellaneous'),
]
